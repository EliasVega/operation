    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Nueva Incremento</h3>
            </div>
            @if (count($errors)>0)
            ...
            @endif
            {!!Form::open(array('url'=>'increment', 'method'=>'POST', 'autocomplete'=>'off'))!!}
            {!!Form::token()!!}
            <div class="box-body row">
                <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label for="increment">Incremento</label>
                        <input type="number" name="increment" class="form-control" placeholder="Incremento">
                    </div>
                </div>
