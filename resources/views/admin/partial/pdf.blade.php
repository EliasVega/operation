...
<html>
    ...
    <header id="header">
        ...
        <!--DATOS company -->
            ...
            <!--DATOS FACTURA -->
            <div id="factura">
                <p> <h4>REMISION <br> <strong id="numfact">N°.{{ $partials->id }}</strong>  </h4>

                </p>
                <p> <h4>FECHA DE EMISION <br> <strong id="datosfact">{{ date('d-m-Y', strtotime($partials->created_at)) }}</strong>  </h4>
                </p>
            </div>
        </div>
    </header>
        ...
        <div class="content">
            ...
            <div class="center">
                ...
                <div id="cliente">
                    ...
                    <div id="titd">
                        <span id="td">{{ $partials->number }}</span><br>
                        <span id="td">{{ $partials->address }}</span><br>
                        <span id="td">{{ $partials->email }}</span><br>
                    </div>
                </div>
                <div id="cliente">
                    <!--DATOS CLIENTE -->
                    ...
                    <div id="titd">
                        <span id="td">{{ $partials->name }}</span><br>
                        <span id="td">{{ $partials->phone }}</span><br>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="tabla">
                        ...
                        <tfoot>
                            ...
                            <tr>
                               ...
                               <td class="footder"><strong>${{number_format($partials->total,2)}}</strong></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
