<div class="box-body row">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="remission_id" value="{{ $remissions->id }}"
    ...
    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="name" value="{{ $remissions->name }}"
                class="form-control" placeholder="" readonly>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
        <div class="form-group" >
            ...
            <input type="text" name="responsible_id" value="{{ $remissions->nameR }}"
                class="form-control" placeholder="" readonly>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
        <div class="form-group" id="user_id">
            ...
            <input type="text" name="user_id" value="{{ $remissions->idO }}"
                class="form-control" placeholder="" readonly>
        </div>
    </div>
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
        <div class="form-group"  id="pend">
            ...
            <input type="number" name="pending" id="pending"
                class="form-control" placeholder="" readonly>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group row">
            ...
            <select name="operation_id" class="form-control selectpicker" id="operation_id"
                ...
                <option
                    value="{{ $or->id }}_{{ $or->price }}_{{ $or->pending }}">
                    {{ $or->name }}</option>
                @endforeach
            </select>
        </div>
